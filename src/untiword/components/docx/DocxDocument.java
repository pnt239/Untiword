...
public class DocxDocument extends DefaultStyledDocument {
     ...
     */
    private Insets pageMargins = new Insets(0, 0, 0, 0);
    private int pageWidth;
    private int pageHeight;
    private PgSz docSize;
    private PgMar docMargins;
    private MyPageData pageData = new MyPageData();
     ...
     * size of BUFFER_SIZE_DEFAULT and has a style context that is scoped by the
     * lifetime of the document and is not shared with other documents.
     */
    public DocxDocument() {
    ...
    /**
     * Deletes table from the document. Method tries to find a deepest table for
     * given offset and deletes it. If no table found method does nothing.
     *
     ...
     * offset and deletes row which contains given offset. If no table found
     * method does nothing.
     *
     * @param offset offset in the document.
     */
     ...
     * given offset and inserts new row above or below (depends on flag)
     * current.
     * <p/>
     * If no table found method does nothing.
     *
     ...
     */
    public PgMar getDocumentMargins() {
        return docMargins;
    }
...
//        return;
    ...
    /**
     * Sets attributes for a paragraphs. This method is thread safe, although
